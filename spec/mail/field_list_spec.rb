...
describe Mail::FieldList do
  ...
  context "when enable :no_header_formatted option" do
    it "should be able to add new fields in the original order" do
      fl = Mail::FieldList.new
      fl.set_options(:no_header_formatted => true)
      fl << Mail::Field.new("To: mikel@me.com")
      fl << Mail::Field.new("From: mikel@me.com")
      fl << Mail::Field.new("Received: from xxx.xxxx.xxx by xxx.xxxx.xxx with ESMTP id 6AAEE3B4D23 for <xxx@xxxx.xxx>; Sun, 8 May 2005 12:30:23 -0500")
      fl << Mail::Field.new("Return-Path: mikel@me.com")
      expect(fl[0].field.class).to eq Mail::ToField
      expect(fl[1].field.class).to eq Mail::FromField
      expect(fl[2].field.class).to eq Mail::ReceivedField
      expect(fl[3].field.class).to eq Mail::ReturnPathField
    end
  end
end
